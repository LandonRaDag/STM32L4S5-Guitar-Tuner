...
volatile uint16_t pcmBuffer[2048];
...
int main(void) {
  ...
  HAL_DFSDM_FilterRegularStart_DMA(&hdfsdm1_filter0, (int32_t*)pdmBuffer, PDM_BUFFER_SIZE);
  ...
  /* USER CODE BEGIN WHILE */
	while (1)
	{
		...
		//HAL_SPI_Receive_DMA(&hspi1, (uint8_t*)pdmBuffer, PDM_BUFFER_SIZE);
